...
if [ -n "$LD_LIBRARY_PATH" ] ; then
   ...
   export LD_LIBRARY_PATH="/usr/local/fdo-3.5.0/lib:/usr/local/lib"
fi
ulimit -s 1024
...
export MENTOR_DICTIONARY_PATH="$MGDIR/share/gis/coordsys"
EXTRA_LIB_PATH="/usr/local/fdo-3.5.0/lib:/usr/local/lib:$MGDIR/lib:$MGDIR/webserverextensions/lib:$MGDIR/webserverextensions/php/lib"
if [ -n "$LD_LIBRARY_PATH" ] ; then
