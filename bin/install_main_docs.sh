...
#base
FILES="index.html banner.bmp jquery.js arramagong.css"
...
# apps
APPS="gpsdrive grass mapfish udig"

for ITEM in $APPS ; do
   wget -r "$OSGEO_SVN/doc/descriptions/${ITEM}_definition.html" \
        --output-document "$DEST/${ITEM}_definition.html"
