...
WSS_QUICKSTART_URL="http://localhost/osgeolive/html/en/quickstart/52nWSS_quickstart.html"
WSS_OVERVIEW_URL="http://localhost/osgeolive/html/en/overview/52nWSS_overview.html"
# -----------------------------------------------------------------------------
#
