...
INSTALLURL="http://www.mapbender.org/builds/3.2.2"
INSTALLFILE="mapbender-starter-v3.2.2"
...
sed -i -e 's/3.2.0/3.2.2/g' "$INSTALL_DIR/mapbender/app/config/parameters.yml"
