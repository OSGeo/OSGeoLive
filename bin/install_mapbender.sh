...
INSTALLURL="http://www.mapbender.org/builds/3.0.8.2"
INSTALLFILE="mapbender-starter-v3.0.8.2"
...
sed -i -e 's/3.0.6.2/3.0.8.2/g' "$INSTALL_DIR/mapbender/app/config/parameters.yml"
