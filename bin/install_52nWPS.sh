...
WPS_QUICKSTART_URL="http://localhost/osgeolive/html/en/quickstart/52nWPS_quickstart.html"
WPS_OVERVIEW_URL="http://localhost/osgeolive/html/en/overview/52nWPS_overview.html"
# -----------------------------------------------------------------------------
#
