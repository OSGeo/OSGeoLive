...
#Install packages
apt-get --assume-yes install qgis=1.7.1 \
   qgis-common=1.7.1 qgis-plugin-grass=1.7.1 python-qgis=1.7.1 python-qgis-common=1.7.1 \
   qgis-plugin-grass-common=1.7.1 gpsbabel grass-doc python-rpy2
