...
WMS_QUICKSTART_URL="http://localhost/osgeolive/html/en/quickstart/ncWMS_quickstart.html"
WMS_OVERVIEW_URL="http://localhost/osgeolive/html/en/overview/ncWMS_overview.html"
