...
WMS_TAR_URL="http://downloads.sourceforge.net/project/ncwms/ncwms/osgeo-1.1/"
WMS_WAR_NAME="ncWMS-1.1.war"
...
WMS_OVERVIEW_URL="http://localhost/en/overview/ncWMS_overview.html"
