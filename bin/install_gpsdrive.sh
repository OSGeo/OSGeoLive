...
if [ $BUILD_LATEST -eq 1 ] ; then
  ...
  for PATCH in $PATCHES ; do
    wget -nv "https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/arramagong_2/app-data/gpsdrive/$PATCH.patch" \
       -O "$PATCH.patch"
...
#wget -c "https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/arramagong_2/app-data/gpsdrive/gpsdrive_syd_tileset-0.1.tar.gz"
