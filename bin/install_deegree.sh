...
getFromOsgeo()
{
    ...
    rm -f $1
    ## wget -c --progress=dot:mega http://download.deegree.org/LiveDVD/FOSS4G2010/$1
    wget -nv http://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4_5/app-conf/deegree/$1
}
...
if [ ! -e "/usr/share/icons/deegree_desktop_48x48.png" ] ; then
   ...
   echo "FIXME: don't use wget for local files, just copy from local svn checkout."
   wget -nv "http://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4_5/app-conf/deegree/deegree_desktop_48x48.png"
