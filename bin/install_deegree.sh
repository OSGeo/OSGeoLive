...
#
# deegree webservices version 3.3.18 runs with openjdk7 on Apache Tomcat 6.0.35
#
...
DEEGREE_FOLDER="$INSTALL_FOLDER/deegree-webservices-3.3.18"
...
wget -N --progress=dot:mega \
   "http://repo.deegree.org/content/groups/public/org/deegree/deegree-webservices/3.3.18/deegree-webservices-3.3.18.zip"
wget -N --progress=dot:mega \
   "http://repo.deegree.org/content/groups/public/org/deegree/deegree-workspace-inspire/3.3.18/deegree-workspace-inspire-3.3.18.deegree-workspace"
...
## unpack as root
cd "$TMP"
unzip -q deegree-webservices-3.3.18.zip
mv deegree-webservices-3.3.18 "$INSTALL_FOLDER"
...
Encoding=UTF-8
Name=Start deegree
Comment=deegree webservices 3.3.18
...
mkdir deegree-workspace-inspire-3.3.18
cd deegree-workspace-inspire-3.3.18
unzip -q "$TMP"/deegree-workspace-inspire-3.3.18.deegree-workspace
