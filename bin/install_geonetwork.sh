...
GEONETWORK_VERSION_FOLDER=v3.2.1
...
then
   ...
   wget -c --progress=dot:mega \
     "https://sourceforge.net/projects/geonetwork/files/GeoNetwork_opensource/$GEONETWORK_VERSION_FOLDER/geonetwork-install-$GEONETWORK_VERSION.jar/download" \
