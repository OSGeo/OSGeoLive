...
then
   ...
   wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4/app-conf/geonetwork/install.xml
fi
...
then
   ...
   wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4/app-conf/geonetwork/jetty.xml
fi
...
then
   ...
   wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4/app-conf/geonetwork/mapServers.xml
fi
...
then
   ...
   wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4/app-conf/geonetwork/start-geonetwork.sh
fi
...
then
   ...
   wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4/app-conf/geonetwork/stop-geonetwork.sh
fi
...
then
	...
	wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4/app-conf/geonetwork/start_geonetwork.desktop
fi
...
then
	...
	wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4/app-conf/geonetwork/stop_geonetwork.desktop
fi
...
then
	...
	wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4/app-conf/geonetwork/geonetwork.desktop
fi
