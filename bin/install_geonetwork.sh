...
then
   ...
   wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4_5/app-conf/geonetwork/install.xml
fi
...
then
   ...
   wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4_5/app-conf/geonetwork/jetty.xml
fi
...
then
   ...
   wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4_5/app-conf/geonetwork/config-gui.xml
fi
...
then
   ...
   wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4_5/app-conf/geonetwork/start-geonetwork.sh
fi
...
then
   ...
   wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4_5/app-conf/geonetwork/stop-geonetwork.sh
fi
...
then
   ...
   wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4_5/app-conf/geonetwork/data-db-mckoi.sql
fi
...
then
   ...
   wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4_5/app-conf/geonetwork/iso-19139-basins-in-africa.mef
fi
...
then
   ...
   wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4_5/app-conf/geonetwork/iso-19139-physiographic.mef
fi
...
then
	...
	wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4_5/app-conf/geonetwork/start_geonetwork.desktop
fi
...
then
	...
	wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4_5/app-conf/geonetwork/stop_geonetwork.desktop
fi
...
then
	...
	wget https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4_5/app-conf/geonetwork/geonetwork.desktop
fi
