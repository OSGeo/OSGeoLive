...
[ -f $DATA_DIR/mapserver-5.6-html-docs.zip ] || \
   wget -c "https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4/app-data/mapserver/mapserver-5.6-html-docs.zip" \
     -O $DATA_DIR/mapserver-5.6-html-docs.zip
[ -f $DATA_DIR/mapserver-itasca-ms56.zip ] || \
   wget -c "https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4/app-data/mapserver/mapserver-itasca-ms56.zip" \
     -O $DATA_DIR/mapserver-itasca-ms56.zip
#[ -f $DATA_DIR/mapserver-gmap-ms54.zip ] || \
#   wget -c "https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4/app-data/mapserver/mapserver-gmap-ms54.zip" \
...
Exec=firefox /usr/local/share/osgeolive-docs/doc/mapserver_description.html
Icon=gnome-globe
Terminal=false
StartupNotify=false
