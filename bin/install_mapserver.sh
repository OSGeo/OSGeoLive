...
[ -f $DATA_DIR/mapserver-6.0-html-docs.zip ] || \
   wget -c "https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_5_0/app-data/mapserver/mapserver-6.0-html-docs.zip" \
     -O $DATA_DIR/mapserver-6.0-html-docs.zip
[ -f $DATA_DIR/mapserver-itasca-ms60.zip ] || \
   wget -c "https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_5_0/app-data/mapserver/mapserver-itasca-ms60.zip" \
