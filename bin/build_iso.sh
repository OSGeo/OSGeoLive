...
wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_7_9/sources.list.d/remastersys.list \
...
wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_7_9/app-data/remastersys.conf \
