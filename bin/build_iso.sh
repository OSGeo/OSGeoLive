...
wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4/sources.list.d/remastersys.list \
...
wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_4/app-data/remastersys.conf \
