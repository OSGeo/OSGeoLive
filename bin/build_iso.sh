...
wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/arramagong_3/sources.list.d/remastersys.list \
...
wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/arramagong_3/app-data/remastersys.conf \
