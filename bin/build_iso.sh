...
wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_6_0/sources.list.d/remastersys.list \
...
wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_6_0/app-data/remastersys.conf \
