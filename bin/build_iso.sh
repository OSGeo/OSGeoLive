...
wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_6_5/sources.list.d/remastersys.list \
...
wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_6_5/app-data/remastersys.conf \
