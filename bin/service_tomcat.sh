...
#
#############################################################################
# Copyright (c) 2009-2026 Open Source Geospatial Foundation (OSGeo) and others.
#
...
apt-get install --yes tomcat10 tomcat10-admin
...
chown tomcat:tomcat /etc/tomcat10/tomcat-users.xml

# something screwed up with the ISO permissions:
chgrp tomcat /usr/share/tomcat10/bin/*.sh
