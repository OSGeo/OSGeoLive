...
wget --progress=dot:binary http://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_5_0/app-data/gvsig/sample-project.gvp \
     --output-document="$USER_HOME/gvSIG/sample-project.gvp"

# download and set up default andami config
wget --progress=dot:binary http://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_5_0/app-conf/gvsig/andami-config.xml \
...
wget --progress=dot:binary http://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_5_0/app-conf/gvsig/gvSIG.sh \
