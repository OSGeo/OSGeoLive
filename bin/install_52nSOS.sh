...
SOS_QUICKSTART_URL="http://localhost/osgeolive/html/en/quickstart/52nSOS_quickstart.html"
SOS_OVERVIEW_URL="http://localhost/osgeolive/html/en/overview/52nSOS_overview.html"
