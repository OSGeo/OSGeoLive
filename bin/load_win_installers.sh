...
wget -c --progress=dot:mega "http://download.codeplex.com/Download?ProjectName=mapwindow4&DownloadId=300267&FileTime=129649216070600000&Build=18416" -O "MapWindow.exe"
