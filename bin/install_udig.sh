...
then
   ...
   wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_6_5/app-conf/udig/udig.sh
fi
...
then
   ...
   wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_6_5/app-conf/udig/uDig.desktop
fi
# copy it into the udig folder
