...
then
   ...
   wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/arramagong_2/udig-conf/udig.sh
fi
...
then
   ...
   wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/arramagong_2/udig-conf/uDig.desktop
fi
# copy it into the udig folder
