...
then
   ...
   wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/arramagong_2/openjump-conf/openjump.sh
fi
...
then
   ...
   wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/arramagong_2/openjump-conf/openjump.ico
fi
# copy it into the openjump folder
...
then
   ...
   wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/arramagong_2/openjump-conf/openjump.desktop
fi
# copy it into the openjump folder
