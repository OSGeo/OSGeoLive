...
then
   ...
   wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/arramagong_3/app-conf/openjump/openjump.sh
fi
...
then
   ...
   wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/arramagong_3/app-conf/openjump/openjump.ico
fi
# copy it into the openjump folder
...
then
   ...
   wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/arramagong_3/app-conf/openjump/openjump.desktop
fi
# copy it into the openjump folder
