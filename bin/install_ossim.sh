...
#Add repositories
#wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/branches/osgeolive_8_0/sources.list.d/ubuntugis.list \
...
#FIXME: does not exist in ubu 14.04: libqt3-mt libpthread-stubs0
