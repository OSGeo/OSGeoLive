...
wget -nv https://svn.osgeo.org/osgeo/livedvd/gisvm/trunk/sources.list.d/ubuntugis-karmic.list \
     --output-document=/etc/apt/sources.list.d/ubuntugis-karmic.list
